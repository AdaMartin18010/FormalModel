...
- [2.5 电磁学模型 / Electromagnetism Models](#25-电磁学模型--electromagnetism-models)
  ...
  - [2.5.1 静电学 / Electrostatics](#251-静电学--electrostatics)
    - [电磁学基础框架图 / Framework Diagram of Electromagnetism Fundamentals](#电磁学基础框架图--framework-diagram-of-electromagnetism-fundamentals)
    - [麦克斯韦方程组关系图 / Relationship Diagram of Maxwell's Equations](#麦克斯韦方程组关系图--relationship-diagram-of-maxwells-equations)
  ...
  - [2.5.4 麦克斯韦方程组 / Maxwell's Equations](#254-麦克斯韦方程组--maxwells-equations)
    - [麦克斯韦方程组求解流程图 / Flowchart of Maxwell's Equations Solution](#麦克斯韦方程组求解流程图--flowchart-of-maxwells-equations-solution)
  ...
  - [2.5.7 电磁介质 / Electromagnetic Media](#257-电磁介质--electromagnetic-media)
...
### 电磁学基础框架图 / Framework Diagram of Electromagnetism Fundamentals
...
### 麦克斯韦方程组关系图 / Relationship Diagram of Maxwell's Equations
...
### 麦克斯韦方程组求解流程图 / Flowchart of Maxwell's Equations Solution

```mermaid
flowchart TD
    Start([开始]) --> Input[输入: 电荷分布ρ, 电流分布J, 边界条件]
    Input --> ChooseForm{选择形式?}
    ChooseForm -->|积分形式| IntegralForm[积分形式]
    ChooseForm -->|微分形式| DiffForm[微分形式]

    IntegralForm --> SetupIntegral[设置积分方程]
    DiffForm --> SetupPDE[设置偏微分方程]

    SetupIntegral --> ApplyBC[应用边界条件]
    SetupPDE --> ApplyBC

    ApplyBC --> SolveE[求解电场 E]
    SolveE --> SolveB[求解磁场 B]

    SolveB --> Verify{验证解?}
    Verify -->|否| AdjustBC[调整边界条件]
    AdjustBC --> ApplyBC
    Verify -->|是| CheckConservation[检查电荷守恒]

    CheckConservation --> CalcEnergy[计算电磁场能量]
    CalcEnergy --> Output[输出: E, B, 能量密度]
    Output --> End([结束])

    style Start fill:#e1f5ff
    style End fill:#e1f5ff
    style SetupIntegral fill:#fff4e1
    style SetupPDE fill:#fff4e1
    style SolveE fill:#e8f5e9
    style SolveB fill:#e8f5e9
    style CheckConservation fill:#ffe1f5
```
...
- [经典力学模型](../01-经典力学模型/README.md) - 电磁场中的带电粒子运动
- [量子力学模型](../02-量子力学模型/README.md) - 量子电动力学，电磁场的量子化
- [相对论模型](../03-相对论模型/README.md) - 相对论电动力学，洛伦兹协变性
- [光学模型](../06-光学模型/README.md) - 电磁波的光学性质，光的电磁理论
- [热力学模型](../04-热力学模型/README.md) - 电磁场的热力学性质，黑体辐射

### 基础理论 / Basic Theory

- [模型分类学](../../01-基础理论/01-模型分类学/README.md) - 电磁学模型的分类
- [形式化方法论](../../01-基础理论/02-形式化方法论/README.md) - 电磁学的形式化方法
- [科学模型论](../../01-基础理论/03-科学模型论/README.md) - 电磁学作为科学模型的理论基础
