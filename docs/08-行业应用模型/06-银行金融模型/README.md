...
1. [8.6.1 风险管理模型](#861-风险管理模型)
2. [8.6.2 投资组合模型](#862-投资组合模型)
3. [8.6.3 期权定价模型](#863-期权定价模型)
4. [8.6.4 信用风险模型](#864-信用风险模型)
5. [8.6.5 利率模型](#865-利率模型)
6. [8.6.6 银行运营模型](#866-银行运营模型)
7. [8.6.7 金融科技模型](#867-金融科技模型)
8. [8.6.8 实现与应用](#868-实现与应用)
